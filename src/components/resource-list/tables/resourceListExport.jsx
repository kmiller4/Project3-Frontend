...
// 		let ui = await axios.get(
// 			'https://my-json-server.typicode.com/avicuna/talent-portal-mock/ui'
// 		);
// 		ui = this.formatData(ui);
// 		this.setState({ ui });

// 		let mobility = await axios.get(
// 			'https://my-json-server.typicode.com/avicuna/talent-portal-mock/mobility'
// 		);
// 		mobility = this.formatData(mobility);
// 		this.setState({ mobility });

// 		let cm = await axios.get(
// 			'https://my-json-server.typicode.com/avicuna/talent-portal-mock/cm'
// 		);
// 		cm = this.formatData(cm);
// 		this.setState({ cm });

// 		let design = await axios.get(
// 			'https://my-json-server.typicode.com/avicuna/talent-portal-mock/design'
// 		);
